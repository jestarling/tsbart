...
//    //*****************************************************************************
//       // FUNCTION:   Calculates log-density for each mcmc iteration, as well as mean,
//    //             and optimally WAIC.
//    //-----------------------------------------------------------------------------
...
//          //             logdens      = Mean log-density across all mcmc iterations.
...
//          // (they are summed together to get log-density for that mcmc draw).
//          mat ll_temp(nd,n);
//
//          // Initialize vector to hold log-density for all mcmc iterations, and double to hold
//          // the mean across mcmc iterations.
//          double logdens;
//
...
//                // Calculate mean log-density across all iterations.
//                //--------------------------------------------------
//
...
//                   }
//
//                // Calculate mean log-loss across all MCMC iterations.
//                logdens = logdens / (nd*n);
//
//                //--------------------------------------------------
...
//
//                   if(doWaic){
//                      // Calculate p_waic and lpd, then combine to get WAIC.
...
//                   }
//
//                // Calculate mean log-density across all MCMC iterations.
//                logdens = logdens / (nd*n);
//
//                //*****************************************************************************
//                   //* Calculate WAIC.
...
//
//                         // Progress report.
//                         // if(i%50==0) cout << "Log-density for WAIC: " << i << " of " << nd <<  endl;
//                      }
//
//                      // Calculate p_waic and lpd, then combine to get WAIC.
...
//                                  _["ll"]        = logdens,  // Mean log-loss over all MCMC iterations.
